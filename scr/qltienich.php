    ...
    <div class="table-center">
        <div class="btn-center">
            <div class="btn-center-bt">
                <a href="them_ti.php" class="button button-them">
            ...
            <table width="100%" class="table-content">
                ...
                <?php 
                    ...
                    while($row=mysqli_fetch_array($kq))
                    {
                        ...
                        echo "<td class='bang'>
                        <a href='sua_ti.php?user=$usern'><ion-icon name='create-outline'></ion-icon></a> 
                        <a href='xoa_ti.php?user=$usern'><ion-icon name='trash-outline'></ion-icon></a>
